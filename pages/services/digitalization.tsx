...
import indexdat from '../../assets/services/digitalization.json'
                            ...
                            >
                                <GridItem colSpan={2}>
                                    <Stack
                                        ...
                                        gridRowGap={{ md: 10 }}
                                    >
                                        <Feature icon={<FaUserTag />} title={indexData.Block1.t1}>
                                            {indexData.Block1.d1}
                                        </Feature>
                                        <Feature icon={<GiSettingsKnobs />} title={indexData.Block1.t2}>
                                            {indexData.Block1.d2}
                                        </Feature>
                                        <Feature icon={<BsSignpostSplit />} title={indexData.Block1.t3}>
                                            {indexData.Block1.d3}
                                        </Feature>
                                        <Feature icon={<SiPinboard />} title={indexData.Block1.t4}>
                                            {indexData.Block1.d4}
                                        </Feature>
                                    </Stack>
                                </GridItem>
