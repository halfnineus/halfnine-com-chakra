...
const Feature = (props: any) => {
  return (
    <Flex>
      ...
      <Box ml={4}>
        <Text fontSize="lg" fontWeight="bold" lineHeight="6" color="gray.900">
          {props.title}
        </Text>
    ...
    <Link href={children.page}>
      ...
      >
        <Box
          ...
          pos={"relative"}
        >
          <Image src={children.imgsrc} layout={"fill"} alt={"background"} />
        </Box>
        <Stack>
          <Text
            color={"blue.500"}
            ...
            <>
              ...
              <Box bg={"#fbfbfb"}>
                ...
                >
                  ...
                  >
                    <Box alignSelf="start">
                      <Heading mb={3} fontWeight="bold" letterSpacing="tight">
                    ...
                    <GridItem colSpan={2}>
                      ...
                      >
                        <Feature
                          icco={<BsRecordCircle />}
                          title={aboutData.block2.txt1}
                        >
                          {aboutData.block2.txt1d}
                        </Feature>
                        <Feature
                          icco={<BsFillFileEarmarkBarGraphFill />}
                          title={aboutData.block2.txt2}
                        >
                          {aboutData.block2.txt2d}
                        </Feature>
                        <Feature
                          icco={<MdSupportAgent />}
                          title={aboutData.block2.txt3}
                        >
                          {aboutData.block2.txt3d}
                        </Feature>
                        <Feature
                          icco={<RiOrganizationChart />}
                          title={aboutData.block2.txt4}
                        >
                  ...
                  >
                    <Box w={{ lg: "50%" }}>
                      <Box
                        ...
                        bgSize="cover"
                        style={{
                          backgroundImage: "url('/img/about/surveyr.webp')",
                        }}
                      ></Box>
                    </Box>
                    ...
                    >
                      ...
                      tenetur, porro consequuntur saepe accusantium consequatur. */}
                        Surveyr.io is made to Schedule Laravel cron jobs. Cron
                        jobs are the backbone of a Laravel application, carrying
                        out critical tasks on behalf of your customers. Yet,
                        often these jobs are hard to monitor as they run in the
                        background. We solve this by monitoring them for you.
                      ...
                      <Box mt={8}>
                        <HStack spacing={2}>
                          <Link target="_blank" href="https://surveyr.io">
                            <Button
                              bg="gray.900"
                              color="gray.100"
                              px={5}
                          ...
                          <Link target="_blank" href="https://dev.surveyr.io">
                            <Button
                              colorScheme="gray"
                              variant="outline"
                              px={5}
